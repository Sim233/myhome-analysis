...
```{r}
ggplot(daAns, aes(y=anslen, x=senti)) + geom_point(color="#6E1DBC", size=0.5) + labs(x="Sentimental score", y="Answer length", title = "2004-2022年反馈信息积极-消极统计分布图") + theme_bw() + scale_y_continuous(limits=c(0,200))
